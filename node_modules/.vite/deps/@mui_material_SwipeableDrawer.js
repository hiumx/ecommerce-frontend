...
import {
  ...
  useRootElementName,
  useSlotProps
} from "./chunk-MCSYNIGB.js";
import "./chunk-63GEV3HX.js";
import {
  useEventCallback_default as useEventCallback_default2
} from "./chunk-HRB7JM2U.js";
import {
  debounce_default,
  ownerDocument_default,
  ownerWindow_default,
  useEnhancedEffect_default as useEnhancedEffect_default2
} from "./chunk-DTNZHO6F.js";
import {
  capitalize_default
} from "./chunk-WRKHVYMA.js";
import {
  rootShouldForwardProp_default,
  styled_default,
  useThemeProps as useThemeProps2
} from "./chunk-FKAHW4CF.js";
import {
  getTransitionProps,
  reflow,
  useTheme
} from "./chunk-DKXV5KLQ.js";
import {
  Transition_default
...
import {
  useForkRef_default
} from "./chunk-P7DEAN5J.js";
import "./chunk-KPCKTKIM.js";
import {
  require_react_dom
} from "./chunk-GVSLPJMJ.js";
import "./chunk-4I5RXQMH.js";
import {
  HTMLElementType,
  chainPropTypes,
  clamp_default,
...
} from "./chunk-7HONNITL.js";
import "./chunk-5DFJHHPD.js";
import {
  clsx_default
} from "./chunk-YV3COZNF.js";
import "./chunk-3EVYITBN.js";
...
var Slider = React46.forwardRef(function Slider2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime26.jsxs)(Root, _extends({}, rootProps, {
    children: [(0, import_jsx_runtime25.jsx)(Rail, _extends({}, railProps)), (0, import_jsx_runtime25.jsx)(Track, _extends({}, trackProps)), marks.filter((mark) => mark.value >= min && mark.value <= max).map((mark, index2) => {
...
var Slide = React68.forwardRef(function Slide2(props, ref) {
  ...
  const childrenRef = React68.useRef(null);
  ...
  const updatePosition = React68.useCallback(() => {
  ...
  return (0, import_jsx_runtime44.jsx)(TransitionComponent, _extends({
    nodeRef: childrenRef,
    onEnter: handleEnter,
    ...
    children: (state, childProps) => {
      return React68.cloneElement(children, _extends({
        ref: handleRef,
        style: _extends({
...
var Drawer = React69.forwardRef(function Drawer2(inProps, ref) {
  ...
  const mounted = React69.useRef(false);
  React69.useEffect(() => {
  ...
  const drawer = (0, import_jsx_runtime45.jsx)(DrawerPaper, _extends({
  ...
  if (variant === "permanent") {
    return (0, import_jsx_runtime45.jsx)(DrawerDockedRoot, _extends({
  ...
  const slidingDrawer = (0, import_jsx_runtime45.jsx)(TransitionComponent, _extends({
    in: open,
  ...
  return (0, import_jsx_runtime45.jsx)(DrawerRoot, _extends({
...
var _excluded29 = ["anchor", "classes", "className", "width", "style"];
...
var SwipeArea = React70.forwardRef(function SwipeArea2(props, ref) {
  const {
    anchor,
    classes = {},
    className,
  ...
  const ownerState = props;
  return (0, import_jsx_runtime46.jsx)(SwipeAreaRoot, _extends({
...
true ? SwipeArea.propTypes = {
   ...
   */
  anchor: import_prop_types30.default.oneOf(["left", "top", "right", "bottom"]).isRequired,
  /**
   * @ignore
   */
...
var _excluded210 = ["anchor", "disableBackdropTransition", "disableDiscovery", "disableSwipeToOpen", "hideBackdrop", "hysteresis", "allowSwipeInChildren", "minFlingVelocity", "ModalProps", "onClose", "onOpen", "open", "PaperProps", "SwipeAreaProps", "swipeAreaWidth", "transitionDuration", "variant"];
...
var SwipeableDrawer = React71.forwardRef(function SwipeableDrawer2(inProps, ref) {
  ...
  const {
    ...
    variant = "temporary"
    // Mobile first.
  } = props, ModalPropsProp = _objectWithoutPropertiesLoose(props.ModalProps, _excluded30), other = _objectWithoutPropertiesLoose(props, _excluded210);
  ...
  return (0, import_jsx_runtime48.jsxs)(React71.Fragment, {
    children: [(0, import_jsx_runtime47.jsx)(Drawer_default, _extends({
      ...
      onClose,
      ref
    }, other)), !disableSwipeToOpen && variant === "temporary" && (0, import_jsx_runtime47.jsx)(NoSsr, {
      children: (0, import_jsx_runtime47.jsx)(SwipeArea_default, _extends({
        anchor,
        ref: swipeAreaRef,
...
true ? SwipeableDrawer.propTypes = {
   ...
   * @default false
   */
  allowSwipeInChildren: import_prop_types31.default.oneOfType([import_prop_types31.default.func, import_prop_types31.default.bool]),
  /**
   * @ignore
   */
   ...
   * @default false
   */
  disableBackdropTransition: import_prop_types31.default.bool,
  /**
   * If `true`, touching the screen near the edge of the drawer will not slide in the drawer a bit
   * to promote accidental discovery of the swipe gesture.
   * @default false
   */
  disableDiscovery: import_prop_types31.default.bool,
  /**
   * If `true`, swipe to open is disabled. This is useful in browsers where swiping triggers
   * navigation actions. Swipe to open is disabled on iOS browsers by default.
   * @default typeof navigator !== 'undefined' && /iPad|iPhone|iPod/.test(navigator.userAgent)
   */
  disableSwipeToOpen: import_prop_types31.default.bool,
  /**
   * @ignore
   */
   ...
   * @default 0.52
   */
  hysteresis: import_prop_types31.default.number,
  /**
   ...
   * @default 450
   */
  minFlingVelocity: import_prop_types31.default.number,
  /**
   * @ignore
   */
  ModalProps: import_prop_types31.default.shape({
    BackdropProps: import_prop_types31.default.shape({
   ...
   */
  SwipeAreaProps: import_prop_types31.default.object,
  /**
   * The width of the left most (or right most) area in `px` that
   * the drawer can be swiped open from.
   * @default 20
   */
  swipeAreaWidth: import_prop_types31.default.number,
  /**
   * The duration for the transition, in milliseconds.
   * You may specify a single timeout for all transitions, or individually with an object.
   * @default {
