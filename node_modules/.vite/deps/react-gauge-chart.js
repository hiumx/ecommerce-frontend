...
function x_default2(x3) {
  ...
  if (typeof x3 !== "function")
    x3 = constant_default6(x3 == null ? 0 : +x3);
  function force(alpha) {
    for (var i = 0, n = nodes.length, node; i < n; ++i) {
...
function y_default2(y3) {
  ...
  if (typeof y3 !== "function")
    y3 = constant_default6(y3 == null ? 0 : +y3);
  function force(alpha) {
    for (var i = 0, n = nodes.length, node; i < n; ++i) {
...
var require_GaugeChart = __commonJS({
  "node_modules/react-gauge-chart/dist/GaugeChart/index.js"(exports) {
    ...
    var GaugeChart = function GaugeChart2(props) {
      ...
      var initChart = (0, _react.useCallback)(function(update) {
        ...
        if (update) {
          renderChart(resize, prevProps2, width, margin, height, outerRadius, g, doughnut, arcChart, needle, pieChart, svg2, props, container, arcData);
          return;
        }
      ...
      (0, _react.useEffect)(function() {
        var handleResize = function handleResize2() {
          var resize = true;
          renderChart(resize, prevProps, width, margin, height, outerRadius, g, doughnut, arcChart, needle, pieChart, svg2, props, container, arcData);
        };
      ...
      var id2 = props.id, style = props.style, className = props.className;
    ...
    var drawNeedle = function drawNeedle2(resize, prevProps, props, width, needle, container, outerRadius, g) {
      var percent = props.percent, needleColor = props.needleColor, needleBaseColor = props.needleBaseColor, hideText = props.hideText, animate = props.animate;
