...
var useCountUp = function useCountUp2(props) {
  ...
  var countUpRef = (0, import_react.useRef)();
  var timerRef = (0, import_react.useRef)();
  var isInitializedRef = (0, import_react.useRef)(false);
...
var CountUp = function CountUp2(props) {
  ...
  var isInitializedRef = import_react.default.useRef(false);
